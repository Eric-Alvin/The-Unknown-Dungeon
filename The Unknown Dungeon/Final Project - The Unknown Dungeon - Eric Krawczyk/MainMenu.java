        ...
        do{
            ...
            bonusdefense = 0;
                ...
                if(Rooms[currentroom] == 1 & dagger == true){
                  ...
                  System.out.println("There is a mimic made of steel and gold, with a ☠ symbol on it, labeled \"War\". It is hostile and is about to attack you.");
                }
            ...
            else if(command.equalsIgnoreCase("EXIT") | command.equalsIgnoreCase("EXIT")){
